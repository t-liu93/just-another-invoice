...
- **Status**: 🟡 Automated implementation and closure completed on 2026-09-01. Blind-review convergence and the author’s final walkthrough/acceptance remain pending; M12 remains in progress and M13 is not active. See `milestones/M12.md`.
...
- **Atomic delivery / acceptance**: Eleven implementation steps cover foundation/migration, mode+chain audit, Advance, Final, Credit, replacement/cancellation, Refund settlement, reports, output/artifacts, frontend and closure. One final 18-point walkthrough reconciles legacy/direct/receipt-only/formal flows, corrections/refunds, retained bytes, concurrency and all reports.
...
| M12 | Advance/Final Invoices and Credit Notes | 🟡 Automated implementation closure complete (2026-09-01; Steps 1–11, Ruff/mypy/default 1125/integration 1065, migrations, codegen no drift, frontend Node/Vitest 122 + build + EN/ZH 1423, Docker/CJK PDF smoke all passed); blind-review convergence and author walkthrough pending |
