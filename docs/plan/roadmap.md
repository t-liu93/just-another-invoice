...
- **Status**: 🟡 Implementation-ready design frozen with the author on 2026-08-28; implementation pending. See `milestones/M12.md`.
...
| M12 | Advance/Final Invoices and Credit Notes | 🟡 Design frozen (2026-08-28; implementation-ready bilingual contract, 11 atomic steps and final 18-point walkthrough complete; implementation pending) |
