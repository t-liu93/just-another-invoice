...
- **不纳入（OUT / 顺延）**：
  ...
  - **报表导出 PDF/CSV 文件** → 本里程碑只做**屏幕展示 + 可复制数字**；导出格式继续无排期地放在[路线图 §4.aa](../roadmap_zh.md)，除非作者要求单独定界里程碑。
...
- **已知遗留 / 顺延项**：
  ...
  - Dashboard 死常量 `_MONTH_LABELS`、未用 i18n 键 `dashboard.loadError` 已从取消的笼统 M13 移入未排期的 roadmap §4.aa 维护积压。
